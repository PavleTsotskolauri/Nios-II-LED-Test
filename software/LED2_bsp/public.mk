...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_led.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x3028
SOPC_SYSID_FLAG += --sidp=0x3028
ELF_PATCH_FLAG  += --sidp 0x3028

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1520454252
SOPC_SYSID_FLAG += --timestamp=1520454252
ELF_PATCH_FLAG  += --timestamp 1520454252
